...
#  PCAP_LIBRARIES            additional libraries needed when linking against libpcap
...
set(PCAP_LIBRARIES "" CACHE PATH "Additional libraries needed by libpcap")
...
if (NOT PCAP_LINKS_SOLO)
    ...
    if (THREADS_FOUND AND PCAP_NEEDS_THREADS)
        set(PCAP_LIBRARIES "${CMAKE_THREAD_LIBS_INIT}" CACHE PATH "Additional libraries needed by libpcap" FORCE)
...
if(PCAP_FOUND)
	add_library(pcap SHARED IMPORTED GLOBAL)
	...
	if(WIN32)
		find_library(PACKET_LIBRARY NAMES packet HITS ${HINT_DIR})
		if(PACKET_LIBRARY)
			add_library(packet SHARED IMPORTED GLOBAL)
			set_target_properties(packet PROPERTIES
				IMPORTED_LOCATION "${PACKE_TLIBRARY}"
				INTERFACE_INCLUDE_DIRECTORIES "${PCAP_INCLUDE_DIR}"
				INTERFACE_LINK_LIBRARIES pcap
				)
		endif()
		mark_as_advanced(PACKET_LIBRARY)
endif()
